...
module.exports = {
    name: 'history',
    description: 'Mostra o histórico de musicas tocadas',
    voiceChannel: false,
...
const queue = useQueue(inter.guild);
        ...
        if (!queue || queue.history.tracks.toArray().length == 0) return inter.editReply({ content: `Nenhuma musica foi tocada ainda`, ephemeral: true });
